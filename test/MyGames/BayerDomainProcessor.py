...
class CFA_Interpolation:
    ...
    def execute(self):
        ...
        R_row_at_G = B_row_at_G = np.array(
            [[0, 0, 1 / 2, 0, 0], [0, -1, 0, -1, 0], [-1, 4, 5, 4, -1], [0, -1, 0, -1, 0], [0, 0, 1 / 2, 0, 0]])
        R_col_at_G = B_col_at_G = R_row_at_G.T
        R_at_B = B_at_R = np.array(
            [[0, 0, -3 / 2, 0, 0], [0, 2, 0, 2, 0], [-3 / 2, 0, 6, 0, -3 / 2], [0, 2, 0, 2, 0], [0, 0, -3 / 2, 0, 0]])
